...
.field-shell { position: relative; display: flex; height: 46px; align-items: center; border: 1px solid #d4dae2; border-radius: 6px; background: #fff; transition: border-color .18s, box-shadow .18s; }.field-shell:focus-within { border-color: #1677ff; box-shadow: 0 0 0 3px #1677ff17; }.field-prefix { display: grid; width: 44px; height: 22px; flex: 0 0 auto; place-items: center; border-right: 1px solid #e8ebef; color: #5f6f83; font: 650 10px/1 ui-monospace, SFMono-Regular, Consolas, monospace; }.field-shell input { min-width: 0; height: 100%; flex: 1; padding: 0 12px; border: 0; outline: 0; background: transparent; color: #26384c; font-size: 14px; }.field-shell input::placeholder { color: #687586; }.password-toggle { height: 30px; margin-right: 6px; padding: 0 8px; border: 0; border-radius: 4px; background: transparent; color: #5f6f83; font-size: 11px; }.password-toggle:hover { background: #f0f5ff; color: #1677ff; }
...
.access-note { display: flex; align-items: center; gap: 10px; margin-top: 28px; padding-top: 20px; border-top: 1px solid #e8ebef; color: #596779; }.access-note > span { display: grid; width: 28px; height: 28px; place-items: center; border: 1px solid #dfe4ea; border-radius: 50%; color: #5c6878; }.access-note p, .access-note b, .access-note small { display: block; margin: 0; }.access-note b { color: #465568; font-size: 11px; }.access-note small { margin-top: 2px; color: #5f6d7d; font-size: 10px; }
